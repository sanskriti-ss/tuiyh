...
for iter in range(max_iters):
    ...
    # generate and print content every 1000 iterations
    if iter % 1000 == 0:
        context = torch.zeros((1, 1), dtype=torch.long, device=device)
        generated = encoding.decode(m.generate(context, max_new_tokens=200)[0].tolist())
        print(f"\n--- Generated after {iter} iterations ---\n{generated}\n")
